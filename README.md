Filmorate — это веб-приложение для управления коллекцией фильмов и взаимодействия пользователей. Приложение позволяет пользователям добавлять фильмы, оценивать их, создавать список друзей и просматривать рекомендации на основе предпочтений.

## Описание проекта

Проект реализует функционал социальной сети для фильмов, где пользователи могут:
- Добавлять фильмы в коллекцию
- Оценивать фильмы (лайкать)
- Добавлять друзей
- Получать рекомендации фильмов на основе рейтинга и жанров
