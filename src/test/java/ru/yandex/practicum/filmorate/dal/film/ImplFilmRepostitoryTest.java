...
import ru.yandex.practicum.filmorate.dal.user.ImplUserRepository;
...
@Import({ImplFilmRepostitory.class, ImplUserRepository.class, BaseFilmService.class, BaseUserService.class})
